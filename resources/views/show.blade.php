...
<body class="bg-slate-100 min-h-screen font-sans antialiased text-slate-800">
                ...
                <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
                    ...
                    <div class="flex items-center gap-5">
                        <div class="p-4 rounded-2xl border border-white/20 shadow-xl shrink-0 flex items-center justify-center"
                            ...
                            <img src="{{ asset('img/logo_mkm.png') }}" alt="MKM Logo" class="h-9 w-auto object-contain">
                        </div>
                        <div>
                            <p class="text-xs font-semibold uppercase tracking-[0.2em] mb-1" style="color: rgba(255,255,255,0.5);">
    ...
    {{-- ===== MAIN CONTENT ===== --}}
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 pt-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                @foreach($shop->documents as $index => $doc)
                    <div class="doc-card group bg-white rounded-2xl border border-slate-200 shadow-sm hover:shadow-xl hover:border-cyan-300 flex flex-col overflow-hidden">
                        ...
                        {{-- Top Color Bar --}}
                        <div class="color-bar h-1 w-full" style="background: linear-gradient(to right, #00677f, #22d3ee, #2dd4bf);"></div>
                        ...
                        <div class="p-5 flex-1 flex flex-col gap-4">
                            ...
                            <div class="flex items-start justify-between">
                                <div class="doc-icon p-3 bg-cyan-50 rounded-xl">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor" class="w-7 h-7 text-cyan-600">
                            ...
                            {{-- Action Button --}}
                            <button onclick="openPdfModal('{{ route('doc.preview', $doc->file_path) }}')"
    ...
    <div id="pdfModal" style="display: none; position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; z-index: 99999; background-color: rgba(15, 23, 42, 0.85); backdrop-filter: blur(4px); align-items: center; justify-content: center; padding: 1.5rem; box-sizing: border-box;">

        <div class="bg-white rounded-2xl shadow-2xl overflow-hidden" style="width: 100%; max-width: 1024px; height: 90vh; display: flex; flex-direction: column;">

            <div class="flex justify-between items-center px-5 py-4 border-b border-slate-200 bg-slate-50" style="flex-shrink: 0;">
                <div class="flex items-center gap-3">
                    <div class="p-2 bg-slate-200 rounded-xl">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-slate-700" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M4.5 2A1.5 1.5 0 003 3.5v13A1.5 1.5 0 004.5 18h11a1.5 1.5 0 001.5-1.5V7.621a1.5 1.5 0 00-.44-1.06l-4.12-4.122A1.5 1.5 0 0011.378 2H4.5zm4 9.5a.75.75 0 000 1.5h3a.75.75 0 000-1.5h-3zm-1-2.75a.75.75 0 01.75-.75h3.5a.75.75 0 010 1.5h-3.5a.75.75 0 01-.75-.75z" clip-rule="evenodd" />
                        </svg>
                    </div>
                    <div>
                        <h2 class="font-bold text-slate-800 text-base leading-none">Preview Dokumen</h2>
                        <p class="text-[11px] font-bold text-slate-400 mt-1 uppercase tracking-wider">Tekan ESC untuk menutup</p>
                    </div>
                </div>

                <button onclick="closePdfModal()" class="p-2 text-slate-400 hover:text-white hover:bg-red-500 rounded-xl transition-all duration-200 active:scale-95" title="Tutup">
            ...
            <div class="bg-slate-200 p-2 sm:p-4" style="flex-grow: 1; display: flex; overflow: hidden;">
                <iframe id="pdfFrame" class="rounded-xl shadow-sm border border-slate-300 bg-white" style="width: 100%; height: 100%; border: none;" src=""></iframe>
            </div>
